...
import org.apache.cloudstack.storage.datastore.driver.AWSS3ObjectStoreDriverImpl;
import org.apache.cloudstack.storage.datastore.lifecycle.AWSS3ObjectStoreLifeCycleImpl;
...
@Component
public class AWSS3ObjectStoreProviderImpl implements ObjectStoreProvider {
    ...
    private final String providerName = "AWS-S3";
    ...
    public boolean configure(Map<String, Object> params) {
        lifeCycle = ComponentContext.inject(AWSS3ObjectStoreLifeCycleImpl.class);
        driver = ComponentContext.inject(AWSS3ObjectStoreDriverImpl.class);
